...
const loadingButtonVariants = {
  ...
  logout:
    'inline-flex items-center cursor-pointer gap-2 rounded bg-slate-700 px-3 py-1 text-sm hover:bg-slate-600 disabled:cursor-not-allowed disabled:opacity-60',
  danger:
